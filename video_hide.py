...
container_outvid = cv2.VideoWriter('my_video/stego.avi',cv2.VideoWriter_fourcc('H','F','Y','U'), 15, (224,224))
...
os.popen("ffmpeg -y -i my_video/stego.avi -i my_video/cover.wav -c:v copy -c:a aac -strict experimental my_video/stego_video_audio.avi")
