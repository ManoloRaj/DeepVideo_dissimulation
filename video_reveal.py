...
secret_outvid = cv2.VideoWriter('my_video/reveal.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 15, (300,300))
...
'''        
os.popen("ffmpeg -y -i my_video/reveal.avi -i my_video/secret.wav -c:v copy -c:a aac -strict experimental my_video/reveal_video_audio.avi")
